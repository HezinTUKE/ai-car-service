...
class OfferIndexDC(DataClassJsonMixin):
    ...
    def format_embedding_text(
        self, service_name: str, city: str, country: str, offer_description: str, human_readable_offer_type: str = ""
    ):
        self.embedding_text = (
            f"{service_name} offers a {human_readable_offer_type} service in {city.title()}, {country.title()}."
